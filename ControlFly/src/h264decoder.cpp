...
const AVFrame& ConverterRGB24::convert(const AVFrame &frame, ubyte* out_rgb)
{
  ...
  av_image_fill_arrays(framergb->data,framergb->linesize, out_rgb, PIX_FMT_RGB24, w, h,1);
  // Do the conversion.
...
{
  return av_image_fill_arrays(framergb->data,framergb->linesize, nullptr, PIX_FMT_RGB24, w, h,1);
}
